...
namespace Microsoft.Azure.IoTSolutions.UIConfig.WebService.v1.Controllers
{
    ...
    public class DeviceGroupFiltersController : Controller
    {
        ...
        [HttpGet]
        public async Task<CacheApiModel> GetAsync()
        {
            return new CacheApiModel(await cache.GetCacheAsync());
        }

        [HttpPost]
        public async Task<ActionResult> UpdateAsync([FromBody] CacheApiModel input)
        {
